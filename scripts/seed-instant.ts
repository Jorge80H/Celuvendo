...
// Productos reales de Celuvendo.com con precios actualizados
const products = [
  ...
  },
  {
    id: id(),
    sku: "MOT-G06-4-128",
    name: "Motorola Moto G06 128GB 4GB RAM",
    slug: "motorola-moto-g06-128gb",
    description: "Valor imbatible con pantalla gigante 6.9\" 120Hz, batería 5200mAh ultra duradera y cargador incluido. Cuero vegano premium e IP64 resistente.",
    brand: "Motorola",
    price: 650000,
    compareAtPrice: null,
    currency: "COP",
  ...
  },
  {
    ...
    slug: "oppo-a5x-128gb",
    description: "Rendimiento 4G confiable con pantalla 120Hz, parlantes estéreo y resistencia IP54. Diseño delgado con gran batería.",
    brand: "OPPO",
    price: 700000,
    compareAtPrice: null,
    currency: "COP",
    images: ["/api/placeholder/oppo-a5x-1.jpg"],
    specifications: {
      screen: { size: "6.67\"", type: "IPS LCD", resolution: "1604 x 720", refreshRate: "120Hz" },
      ...
      battery: { capacity: "5000mAh", charging: "25W VOOC" },
      connectivity: ["4G LTE", "WiFi 5", "Bluetooth 5.0"],
      os: "Android 14 (ColorOS 14)"
    },
    features: ["Parlantes estéreo", "120Hz display", "IP54", "Jack 3.5mm"],
    stock: 19,
    isActive: true,
    isFeatured: false,
    rating: 4.2,
  ...
  // Xiaomi Products (2 productos)
  {
    id: id(),
    sku: "XIA-REDMI15-8-256",
    name: "Redmi 15 256GB 8GB RAM",
    slug: "redmi-15-256gb",
    description: "Nuevo Redmi 15 con pantalla AMOLED, cámara de alta calidad y batería de larga duración. Rendimiento excepcional para uso diario.",
    brand: "Xiaomi",
    price: 800000,
    compareAtPrice: null,
    currency: "COP",
    images: ["/api/placeholder/redmi-15-1.jpg"],
    specifications: {
      screen: { size: "6.67\"", type: "AMOLED", resolution: "1080 x 2400", refreshRate: "120Hz" },
      processor: "MediaTek Helio G99",
      ram: "8GB",
      storage: "256GB",
      camera: { main: "50MP", front: "16MP", features: ["HDR", "Modo nocturno"] },
      battery: { capacity: "5000mAh", charging: "33W fast charging" },
      connectivity: ["4G LTE", "WiFi 5", "Bluetooth 5.2", "NFC"],
      os: "Android 14 (MIUI 15)"
    },
    features: ["Pantalla AMOLED 120Hz", "Cámara 50MP", "Carga rápida 33W"],
    stock: 30,
    isActive: true,
    isFeatured: true,
    rating: 4.4,
  ...
  {
    id: id(),
    sku: "XIA-REDMI-NOTE14P-8-256",
    name: "Redmi Note 14 Pro 256GB 8GB RAM",
    slug: "redmi-note-14-pro-256gb",
    description: "Redmi Note 14 Pro con cámara profesional, pantalla AMOLED de 120Hz y carga rápida de 67W. Potencia y estilo en un solo dispositivo.",
    brand: "Xiaomi",
    price: 1050000,
    compareAtPrice: null,
    currency: "COP",
    images: ["/api/placeholder/redmi-note14-pro-1.jpg"],
    specifications: {
      screen: { size: "6.67\"", type: "AMOLED", resolution: "1080 x 2400", refreshRate: "120Hz" },
      processor: "MediaTek Dimensity 7200",
      ram: "8GB",
      storage: "256GB",
      camera: { main: "200MP", ultrawide: "8MP", macro: "2MP", front: "16MP", features: ["OIS", "HDR", "Modo nocturno"] },
      battery: { capacity: "5000mAh", charging: "67W fast charging" },
      connectivity: ["5G", "WiFi 6", "Bluetooth 5.3", "NFC"],
      os: "Android 14 (MIUI 15)"
    },
    features: ["Cámara 200MP", "Carga 67W", "Pantalla AMOLED 120Hz", "OIS"],
    stock: 25,
    isActive: true,
    isFeatured: true,
    rating: 4.6,
  ...
  },
  {
    id: id(),
    sku: "SAM-A07-6-128",
    name: "Samsung Galaxy A07 128GB 6GB RAM",
  ...
  },
  {
    id: id(),
    sku: "SAM-A16-8-128",
    name: "Samsung Galaxy A16 128GB 8GB RAM",
    slug: "samsung-galaxy-a16-128gb",
    description: "Samsung A16 con pantalla Super AMOLED de 6.7\", cámara triple 50MP y batería 5000mAh. 6 años de actualizaciones garantizadas.",
    brand: "Samsung",
    price: 750000,
    compareAtPrice: null,
    currency: "COP",
    ...
    specifications: {
      ...
      battery: { capacity: "5000mAh", charging: "25W compatible" },
      connectivity: ["4G LTE", "WiFi 5", "Bluetooth 5.3", "NFC"],
      os: "Android 15 (One UI 6.1)"
    },
    features: ["Super AMOLED 90Hz", "6 años actualizaciones", "Triple cámara 50MP"],
    stock: 20,
    isActive: true,
    isFeatured: true,
    rating: 4.4,
  ...
  },
  {
    ...
    compareAtPrice: null,
    currency: "COP",
    images: ["/api/placeholder/samsung-a16-5g-1.jpg"],
    specifications: {
      screen: { size: "6.7\"", type: "Super AMOLED", resolution: "1080 x 2340", refreshRate: "90Hz" },
  ...
  },
  {
    id: id(),
    sku: "SAM-A16-8-256",
    name: "Samsung Galaxy A16 256GB 8GB RAM",
    slug: "samsung-galaxy-a16-256gb",
    description: "Samsung A16 versión de 256GB con pantalla Super AMOLED, cámara triple 50MP y batería de larga duración. 6 años de actualizaciones.",
    brand: "Samsung",
    price: 850000,
    compareAtPrice: null,
    currency: "COP",
    images: ["/api/placeholder/samsung-a16-256-1.jpg"],
    specifications: {
      screen: { size: "6.7\"", type: "Super AMOLED", resolution: "1080 x 2340", refreshRate: "90Hz" },
      processor: "MediaTek Helio G99",
      ram: "8GB",
    ...
    features: ["Super AMOLED 90Hz", "256GB storage", "6 años actualizaciones", "Triple cámara"],
    stock: 22,
    isActive: true,
    isFeatured: true,
    rating: 4.5,
  ...
  },
  {
    ...
    description: "Flagship killer con Snapdragon 7 Gen 1, pantalla Super AMOLED Plus de 120Hz, cámara triple 50MP con OIS, selfie cam 50MP y carga súper rápida 45W.",
    brand: "Samsung",
    price: 900000,
    compareAtPrice: null,
    currency: "COP",
    ...
    features: ["Selfie cam 50MP", "Carga 45W", "Dolby Atmos", "Ultra delgado 7.8mm"],
    stock: 12,
    isActive: true,
    isFeatured: true,
    rating: 4.7,
...
async function seedDatabase() {
  ...
  console.log("   Productos reales de Celuvendo.com (14 total)\n");
